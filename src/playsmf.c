...
static BOOL WINAPI HandlerRoutine(DWORD dwCtrlType) { if (dwCtrlType) { V0 = EntryLabel->Idx; } else { V0 = ExitLabel->Idx; ExitVal |= 4; } CallMyMacro0(); return(TRUE); }
...
EntryLabel->ReT = 8; AlignLabels(Labels);
